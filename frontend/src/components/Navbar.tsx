...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      {/* Desktop Header */}
      <header className="sticky top-0 z-40 hidden md:block w-full border-b border-blue-900/60 apple-glass-chrome">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
          <NavLink to="/" className="flex items-center gap-3 group apple-press" onClick={() => triggerHaptic('light')}>
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-blue-800 shadow-lg shadow-blue-600/30 group-hover:scale-105 transition-transform border border-blue-400/30">
      ...
      <div className="md:hidden sticky top-0 z-40 w-full apple-glass-chrome border-b border-blue-900/60 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-blue-800 shadow-md shadow-blue-600/30 border border-blue-400/30">
            <Dumbbell className="h-5 w-5 text-amber-400 stroke-[2.5]" />
          </div>
          <div>
            ...
            <p className="text-[10px] text-blue-400 font-bold">Higher Volume • KG</p>
          </div>
        </div>
        ...
        {user ? (
          ...
          <button
            ...
            className="rounded-lg bg-amber-400/10 px-2.5 py-1 text-[10px] font-black text-amber-400 border border-amber-400/30 apple-press"
          >
            Sign In
          </button>
        )}
